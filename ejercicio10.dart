...
class Resenia {
  ...
  // Constructor
  Resenia(this.usuario, this.calificacion, this.comentario, this.fecha, this.utilidad);
...
void main() {
  // Crear reseñas
  Resenia r1 = Resenia("Carlos", 5, "Excelente aplicación", "2025-08-24", 10);
  Resenia r2 = Resenia("Laura", 3, "Podría mejorar", "2025-08-23", 4);
